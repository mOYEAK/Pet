...
7. 在用户端「智能客服」输入“帮咪咪预约明天下午3点的猫咪洗护”，查看草案并回填预约页。
8. 在用户端「通知中心」查看明日预约的自动到店提醒。
9. 在后台「AI 经营助手」询问本月收入和热门服务。
10. 在后台「营销文案」生成活动文案草案。
11. 在后台「客户召回」筛选长期未消费客户并创建跟进任务。
12. 在「知识库」维护客服问答内容，在「系统设置」查看门店基础信息。
